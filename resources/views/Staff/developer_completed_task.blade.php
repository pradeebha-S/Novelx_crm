...
<div class="row align-items-center justify-content-between mb-3">
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <!-- Back Button -->
        <button type="button" class="btn btn-icon bg-white waves-effect"
        ...
        <!-- Title -->
        <h5 class="mb-0">Testing Pending Tasks</h5>

    </div>

    <!-- RIGHT SIDE BUTTON -->
    <a href="{{ route('testing_completed_tasks') }}" class="btn btn-success btn-sm">
...
<script>
    $(function() {
        $('#dept').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('developer_task_table_data') }}",
            language: {
                search: "",
