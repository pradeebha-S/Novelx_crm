...
<ul class="nav nav-pills flex-column flex-sm-row mb-4 gap-sm-0 gap-2 mt-4">
    ...
    <li class="nav-item">
        <a class="nav-link active waves-effect waves-light" href="{{ route('wfh') }}">Work From Home</a>
    </li>
    <li class="nav-item">
...
<div class="card p-3">
    ...
    <form action="{{ route('request_wfh') }}" method="POST" id="login_form">
        @csrf
        <div class="row">
            ...
            <span class="text-danger fw-bold small">Note: Please ensure you have informed the Project Incharge, HR, or
                Project
