        ...
        View
                ...
                <div class="mt-auto text-center pt-3">
                    ...
                    <a href="#" class="text-danger fw-bold"
                       ...
                       data-bs-target="#reopenStatusModal"
        ...
        <div class="card shadow-sm border-2 rounded-3 p-3 h-100 w-100">
            ...
            <div class="row p-5 align-items-center">
                ...
                <div class="col-6 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('view_staff_reopen_history', ['task_id' => $task->id]) }}"
        ...
        <div class="card shadow-sm border-2 rounded-3 p-3 h-100 w-100">
            ...
            <div class="row p-5 align-items-center">
                ...
                <div class="col-6 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('view_staff_hold_history', ['task_id' => $task->id]) }}"
...
<div class="modal fade" id="reopenStatusModal" tabindex="-1">
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
        ...
        <div class="modal-content rounded-4 px-4 py-5 text-center">
            ...
            <form action="{{ route('submit_reopen_status') }}" method="POST" id="modelform">
