...
@section('content')
    ...
    <ul class="nav nav-pills flex-column flex-sm-row mb-4 gap-sm-0 gap-2 mt-4">
        ...
        <li class="nav-item">
            <a class="nav-link active waves-effect waves-light" href="{{ route('permission') }}">Permission</a>
        </li>
    </ul>
    <div class="card p-3">
        <h5 class="text-center text-decoration-underline">Permission Request</h5>
        <form action="{{ route('request_permission') }}" method="POST" id="login_form">
            @csrf
            <div class="row">
                ...
                <div class="col-lg-6 mb-2">
                    <label class="form-label">Informed To <span class="text-danger">*</span></label>
                    <select class="form-select" name="informed_to">
    ...
    <option value="no">No</option>
              ...
              <span class="text-danger fw-semibold mt-2 small typing-text">
                        ...
                        <table id="dept" class="table">
                            <thead>
                                <tr>
                                    <th>SNO</th>
                                    <th>Date</th>
                                    <th class="text-nowrap">From Time</th>
                                    <th class="text-nowrap">To Time</th>
