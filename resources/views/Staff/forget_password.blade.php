        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-xl-7 align-items-center p-sm-12 p-6">
                <div class="w-px-400 mx-auto mt-5 pt-5">
                    ...
                    <form id="forget_form" class="mb-6 mt-3 fv-plugins-bootstrap5 fv-plugins-framework"
                        action="{{ route('staff_forget_verifyotp') }}" method="POST" novalidate="novalidate">
                        @csrf
                        ...
                        <button class="btn btn-primary d-grid w-100 waves-effect waves-light" id="submitBtn">Submit</button>
                        <input type="hidden">
                    </form>
                    <p class="text-center">Can't Change Password? <a href="{{ route('login') }}"><b class="text-danger">Login</b></a></p>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#sendOtpBtn").on('click', function (e) {
                ...
                $.ajax({
                    url: "{{ route('staff_forget_sendotp') }}",   // correct route for this page
                    type: "POST",
                    dataType: "json",
                    data: {
                        email: email,
