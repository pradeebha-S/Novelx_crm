        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu">
                ...
                <ul class="menu-inner py-1">
                    <li class="menu-item  @if(Route::is('intern.dashboard')) active @endif">
                        <a href="{{ route('intern.dashboard') }}" class="menu-link">
                            <i class="menu-icon icon-base ti tabler-smart-home"></i>
                            <div data-i18n="Dashboard">Dashboard</div>
                        </a>
                    </li>
                    
                      <li class="menu-item @if(Route::is('intern_task')) active @endif">
                        <a href="{{ route('intern_task') }}" class="menu-link">
                            <i class="menu-icon icon-base ti tabler-report"></i>
                            <div data-i18n="Task">Task</div>
                        </a>
                    </li>
                    
                    <li class="menu-item @if(Route::is('intern.attendance')) active @endif">
                        <a href="{{ route('intern.attendance') }}" class="menu-link">
                            <i class="menu-icon icon-base ti tabler-calendar"></i>
                            <div data-i18n="Attendance">Attendance</div>
                        </a>
                    </li>
                   
                    <li class="menu-item @if(Route::is('intern_reset_password')) active @endif">
                        <a href="{{ route('intern_reset_password') }}" class="menu-link">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content rounded-4 text-center p-4 py-5">
                ...
                <div class="d-flex justify-content-center align-items-center gap-3 mt-4">
                    <form action="{{ route('intern_logout') }}" method="GET" id="logoutForm">
                        @csrf
