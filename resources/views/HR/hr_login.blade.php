            ...
            <div class="w-px-400 mx-auto mt-12 pt-5">
                ...
                <form method="POST" action="{{ route('staff_login_verifyotp') }}" id="login_form">
                    ...
                    <div class="mb-6 fv-plugins-icon-container">
                        ...
                        <input type="email" class="form-control p-3 bg-white" value="{{ old('email') }}"
                            id="email" name="email" placeholder="Enter your email id" autofocus required>
                        @error('email')
                    ...
                    <div class="mb-1 form-password-toggle form-control-validation fv-plugins-icon-container">
                        ...
                        <div class="input-group mb-9">
                            ...
                            <input type="text" id="otp" class="form-control p-3" name="otp"
                                placeholder="Enter OTP" style="color: #000;">
                        </div>
                    </div>
