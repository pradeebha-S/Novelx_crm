...
<div id="display_error" class="mt-2"></div>
          ...
          <form action="{{ route('new_password') }}" method="POST" id="login_form">
            @csrf
            ...
            <div class="mb-6 form-password-toggle form-control-validation fv-plugins-icon-container">
              ...
              <div class="input-group input-group-merge has-validation">
                <input type="password" id="password_confirmation" class="form-control p-3" name="password_confirmation"
            ...
            <button class="btn btn-primary d-grid w-100 waves-effect waves-light" id="submit_btn">Submit</button>
          </form>
