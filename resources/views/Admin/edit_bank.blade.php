...
<div class="card p-4 mt-4">
    <h6>Edit Project</h6>
   <form action="{{ route('update_bank') }}" method="POST" id="login_form">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-2">
            ...
            <input type="text" name="holder_name"
                value="{{ old('holder_name', $bank->holder_name) }}"
        ...
        <div class="col-lg-6 mb-2">
            ...
            <select name="gst" class="form-control">
                <option value="Yes" {{ $bank->gst == 'Yes' ? 'selected' : '' }}>Yes</option>
                <option value="No" {{ $bank->gst == 'No' ? 'selected' : '' }}>No</option>
            </select>
        </div>
