                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    {{ \App\Models\User::where('id', $row->user_id)->value('name') ?? 'N/A' }}
                                </td>
                                <td>{{ $row->from }}</td>
                                <td>{{ $row->to }}</td>
                                <td>{{ $row->reason }}</td>
                                <td>{{ $row->remark }}</td>
                                <td class="text-nowrap"> <button class="btn btn-label-success open-reply"
                                        data-id="{{ $row->id }}" data-bs-toggle="modal"
                                        data-bs-target="#reply">Approved</button>
                                </td>
                            </tr>
                            @endforeach
