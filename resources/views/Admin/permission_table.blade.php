...
@section('content')
    ...
    <div class="row me-6">
        ...
        <div class="col-lg-11">
            ...
            <ul class="nav nav-pills flex-column flex-sm-row mb-4 gap-sm-0 gap-2 mt-4">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link waves-effect active waves-light"

                        href="{{ route('permission_table') }}">Permission</a>
        ...
        <div class="col-lg-1">
            ...
            <a href="{{ route('permission_history') }}"> <button class="btn btn-primary">Histories</button></a>
    ...
    <div class="modal fade" id="reply" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-dialog modal-md modal-dialog-centered">
            ...
            <div class="modal-content rounded-4 p-4 py-5">
                ...
                <form action="{{ route('permission_reply') }}" method="post" id="replyForm">
    ...
    <script>
        ...
        jq(document).ready(function () {
            ...
            jq('#dept').DataTable({
                ...
                ajax: "{{ route('permission_table_data') }}",
