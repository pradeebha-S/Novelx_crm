...
<div class="row align-items-center justify-content-between mb-3">
    ...
    <!-- Button -->
    <div class="col-auto">
        <a href="{{ route('create_reminder') }}"> <button class="btn buttons-collection btn-primary" type="button"
...
<div class="modal fade" id="delete" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content rounded-4 text-center p-4 py-5">
            ...
            <form id="deleteForm" method="POST" action="{{ route('delete_reminder') }}">
                @csrf
...
<div class="modal fade" id="completeModal" tabindex="-1" data-bs-backdrop="static">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content rounded-4 text-center p-4 py-5">
            ...
            <form action="{{ route('complete_reminder') }}" method="POST">
                @csrf
...
$(document).on('click', '.statusBtn', function () {
    ...
    $(document).ready(function() {
        ...
        $('#dept').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.reminder_data') }}",
            language: {
                search: "",
