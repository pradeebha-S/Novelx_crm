...
<div class="row me-6">
    ...
    <div class="col-lg-11">
        ...
        <ul class="nav nav-pills flex-column flex-sm-row mb-4 gap-sm-0 gap-2 mt-4">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link active waves-effect waves-light" href="#">Work From Home</a>
    ...
    <div class="col-lg-1">
        ...
        <a href="{{ route('wfh_history') }}"> <button class="btn btn-primary">Histories</button></a>
...
<div class="modal fade" id="reply" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        ...
        <div class="modal-content rounded-4 p-4 py-5">
            ...
            <form action="{{ route('wfh_reply') }}" method="post" id="replyForm">
