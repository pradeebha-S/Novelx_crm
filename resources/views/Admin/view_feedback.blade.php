...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8 col-12">
            <div class="parchment-bg position-relative" style="min-height: 500px; max-width: 620px;">
                <img src="{{ asset('assets/img/flower.png') }}" class="flower-top" alt="Flower decoration"
                    onerror="this.style.display='none'" style="opacity:0.2;">
                <!-- <img src="{{ asset('assets/img/feather.png') }}" class="quill-img" alt="Quill feather"
                ...
                <div class="content-wrapper col-lg-6">
                    ...
                    <div class="text-center">
                        <p class="feedback-text">{{ $feedback->positive_feedback }}</p>
                    </div>
                    <div class="text-center mb-0">
                    ...
                    <div class="text-center">
                        <p class="feedback-text">{{ $feedback->negative_feedback }}</p>
                    </div>
                    <div class="text-center mb-0">
                    ...
                    <div class="text-center">
                        <p class="feedback-text">{{ $feedback->suggestions }}</p>
                    </div>
                    <div class="text-center mb-0">
                    ...
                    <div class="text-center">
                        <p class="feedback-text">{{ $feedback->additional_feedback }}</p>
                    </div>
                </div>
            </div>
        </div>
