...
$(function () {
    $('#dept').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('reopen_data', $staff_id) }}", // ✔ FIXED
    ...
    { data: 'task_name', name: 'tasks.task_name' },
    { data: 'reopen_type', name: 'task_histories.reopen_type' },
    { data: 'remark', name: 'task_histories.remark' },
    { data: 'created_at', name: 'task_histories.created_at' }
]
