...
<div class="row align-items-center justify-content-between mb-3">
    <!-- Heading -->
    <div class="col-auto">
        <h5>Common Request</h5>
    </div>

    <!-- Button -->
    <div class="col-auto">
        <a href="{{ route('common_request_history_table') }}"> <button class="btn buttons-collection btn-primary" type="button" aria-haspopup="dialog"
                aria-expanded="false">
...
<div class="modal fade" id="form" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content rounded-4 p-4 py-5">
            ...
            <form action="{{ route('remark_form') }}" method="post" id="replyForm">
                @csrf
...
<script>
    ...
    jq(document).ready(function() {
        jq('#dept').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('common_request_table_data') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    orderable: false,
                    searchable: false
