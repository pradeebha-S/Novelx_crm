...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets') }}/n.png">
    ...
    @if (session('success') || session('error') || $errors->any())
        <div class="position-fixed top-0 end-0 p-3" style="z-index: 9999; max-width: 100%;">
            <div id="liveToast"
                ...
                role="alert" aria-live="assertive" aria-atomic="true" style="min-width: 250px; max-width: 90vw;">
        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-xl-7 align-items-center authentication-bg p-sm-12 p-6">
                <div class="w-px-400 mx-auto mt-12 pt-5">
                    ...
                    <form method="POST" action="{{ route('login_verifyotp') }}" id="login_form">
                        @csrf
                        ...
                        <div class="mb-6 fv-plugins-icon-container">
                            ...
                            <input type="text" class="form-control p-3 bg-white" value="{{ old('email') }}" id="email"
                    ...
                    <p class="text-center">Can't Change Password? <a href="{{ route('login') }}"><b>Login</b></a></p>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status === "success") {
                            ...
                            // Disable the button to prevent immediate resend; change text
